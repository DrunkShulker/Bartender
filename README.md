...
You can use any hack client with Bartender, but only Impact and Kami BLUE are tested to be compatible. **This mod is built and tested on Windows**. It runs on MAC too, but all features do not function properly! (Don't waste your money in alt accounts if you are on MAC)
